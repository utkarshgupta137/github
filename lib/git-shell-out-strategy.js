...
export default class GitShellOutStrategy {
  ...
  async getDiffsForFilePath(filePath, {staged, baseCommit, ignoreEolWhitespace, ignoreWhitespaceChange, ignoreWhitespace} = {}) {
    ...
    else if (ignoreWhitespaceChange) { args.push('--ignore-space-change'); }
    else if (ignoreEolWhitespace) { args.push('--ignore-space-at-eol'); }
